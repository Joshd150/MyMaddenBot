...
// Removed: import { DiscordIcon, YouTubeIcon, TwitterIcon, TikTokIcon, InstagramIcon } from "@/components/icons/social-icons"
    ...
    <Card className="bg-muted/30 border-primary/20 flex flex-col">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          {/* Removed: <TwitterIcon className="h-5 w-5" /> */} {title}
        </CardTitle>
      </CardHeader>
          ...
          <div className="pl-3 ml-1 border-l border-primary/20">
            <Button asChild size="sm">
              <Link href="https://discord.com" prefetch={false}>
                {/* Removed: <DiscordIcon className="mr-2 h-5 w-5" /> */} Join
              </Link>
            </Button>
          </div>
        </div>
        ...
        >
          <div className="flex flex-col items-center justify-center h-full gap-8 text-lg font-medium">
            ...
            <Button asChild size="lg">
              <Link href="https://discord.com" prefetch={false}>
                {/* Removed: <DiscordIcon className="mr-2 h-5 w-5" /> */} Join Discord
              </Link>
            </Button>
          </div>
        </div>
          ...
          <div className="container px-4 md:px-6 flex flex-col items-center">
            ...
            <div className="mt-8">
              <Button asChild size="lg" className="bg-primary hover:bg-primary/90 text-lg px-8 py-6">
                <Link href="https://discord.com" prefetch={false}>
                  {/* Removed: <DiscordIcon className="mr-2 h-6 w-6" /> */} Join the VFL Waitlist
                </Link>
              </Button>
            </div>
          </div>
